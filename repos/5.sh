RELEASES_URL="https://api.github.com/repos/zzh20188/GKI_KernelSU_SUSFS/releases?per_page=2"
...
log "$STR_KERNEL_VERSIONS_REPO_MESSAGE zzh20188/GKI_KernelSU_SUSFS"
