RELEASES_URL="https://api.github.com/repos/KernelSU-Next/KernelSU-Next/releases?per_page=2"
...
log "$STR_KERNEL_VERSIONS_REPO_MESSAGE KernelSU-Next/KernelSU-Next"
